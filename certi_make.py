...
sh = gc.open_by_url("https://docs.google.com/spreadsheets/d/17s9JZlpPUtJUipwD2w-tKA1MtwJHg3sz9sDYVJXINVU/edit#gid=0") # Link to Google sheet.
...
for i in range(0, n):
    ...
    draw.text(((W - w) / 2, (H - 30) / 2), name, font=myFont, fill="black")
    draw.text((88, 270), uid, font=myFont2, fill="black")
    str1 = uid
    str2 = '.jpg'
    fname = str1 + str2
    # fname2='certis/'+fname
